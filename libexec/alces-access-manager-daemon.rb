...
DaemonKit::Application.running! do |config|
  module ::Alces
    module Tools
      module SSLConfigurator
        ...
        def ssl_verify_mode
          if Alces::AccessManagerDaemon.config.ssl.verify == false
  ...
  Alces::AccessManagerDaemon.setup! do |daemon|
    daemon.load_config('access-manager-daemon')
  ...
  Alces::Tools::DRb.listen(Alces::AccessManagerDaemon.config, Alces::AccessManagerDaemon::Control.new)
end
